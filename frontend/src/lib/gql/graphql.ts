...
export type RoomEventType = CallParticipantJoinedEvent | CallParticipantLeftEvent | MessageDeletedEvent | MessageEditedEvent | MessagePostedEvent | MessageRetractedEvent | MessageUpdatedEvent | PresenceChangedEvent | ReactionAddedEvent | ReactionRemovedEvent | RoomArchivedEvent | RoomCreatedEvent | RoomDeletedEvent | RoomUnarchivedEvent | RoomUpdatedEvent | ServerMemberDeletedEvent | UserJoinedRoomEvent | UserLeftRoomEvent | UserTypingEvent | VideoProcessingCompletedEvent;
